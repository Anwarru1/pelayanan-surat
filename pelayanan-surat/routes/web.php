...
Route::middleware('auth:daftar')->group(function(){
    ...
    Route::post('/domisili/profil/update-data-diri', [ProfilController::class, 'updateProfil'])->name('profil.updateDataDiri');
    Route::post('/domisili/profil/update-data-tambahan', [ProfilController::class, 'updateBerkas'])->name('profil.updateDataTambahan');
