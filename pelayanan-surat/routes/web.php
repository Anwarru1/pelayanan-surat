...
Route::get('/clear-cache', function() {
    ...
    return "Cache sudah dibersihkan!";
});
...
Route::middleware('auth:daftar')->group(function(){
    ...
    Route::post('/domisili/profil/update-data-diri', [ProfilDomisiliController::class, 'updateProfil'])->name('profil.updateDataDiri');
    Route::post('/domisili/profil/update-data-tambahan', [ProfilDomisiliController::class, 'updateBerkas'])->name('profil.updateDataTambahan');
