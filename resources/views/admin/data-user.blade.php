                                ...
                                <div class="card-body">
                                    <div class="toolbar row mb-3">
                                        <div class="col ml-auto">
                                            <div class="dropdown float-right">
                                                <button type="button" class="btn btn-primary ml-3 float-right" data-toggle="modal"
                                                    data-target="#storePengguna">Tambah +</button>
                                                <x-pengguna />
                                                <button class="btn btn-danger" type="button" title="Hapus terpilih"
                                    ...
                                    <!-- Bulk Delete Form (HANYA mencakup checkbox) -->
                                            ...
                                            <tbody>
                                                @foreach ($penggunas as $pengguna)
                                                    <tr>
                                                        ...
                                                        <td>
                                                            <!-- Tombol Edit (jangan submit form) -->
                                                            <button type="button" class="btn btn-sm btn-warning"
                                                                data-toggle="modal" data-target="#editPengguna{{ $pengguna->id }}">
                                                                Edit
                                                            </button>

                                                            <!-- Modal Edit (komponen blade) -->
